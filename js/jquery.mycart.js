    ...
    var drawTable = function(){
      ...
      $.each(products, function(){
        ...
        $cartTable.append(
          ...
          '</tr>'*/
          '<div class="col-xs-12 no-padding cartitem" style="text-align:left !important; margin-top:20px; margin-bottom:12px !important; border-bottom:1px solid #e4e4e4" title="' + this.summary + '" data-id="' + this.id + '" data-price="' + this.price + '">' +
              ...
              '<div class="col-xs-8 no-padding">' +
                ...
                '<div class="col-xs-4 no-padding align-left" >' +
                   ...
                   '<input title="Total" class="sl-qty '+ classProductQuantity +'" value="' + this.quantity + '" name="day" style="margin-left:5px; position:absolute;display:inline; width:27px; background:none; font-size:13pt !important; height:37px; text-align:center; border:none; margin-top:1px;" disabled />' +
      ...
      if(localStorage.hd_lang==="IDN"){
        ...
        '<div class="extras col-xs-12" style="position:fixed;bottom: 125px;text-align: left;background: #2A9F8A;color: white;padding: 7px 10px 10px 12px;">'+
          ...
          '<div class="col-xs-6 no-padding align-right">'+
            '<img src="img/checked.svg" width="16">'+
          '</div>'+
        '</div>'+
      ...
      '<button type="button" class=" ' + classCheckoutCart + '">Checkout</button>'*/
        ...
        '<div class="col-xs-12 " style="font-size:18pt;" role="alert" id="' + idEmptyCartMessage + '">Aduh! Keranjangmu kosong.</div>'+
        ...
        '<button type="button" class=" ' + classCheckoutCart + '">Checkout</button>'*/
          ...
          : '<img style="margin-top:53%; opacity:0.4" src="img/cartempty.png" width="20%" />'+
          '<div class="col-xs-12 " style="font-size:18pt;" role="alert" id="' + idEmptyCartMessage + '">Oops! Your cart is empty</div>'+
